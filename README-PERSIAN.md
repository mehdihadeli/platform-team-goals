...
## ترکیب تیم و فرهنگ
- داشتن مهندسین با تجربه هم در توسعه و هم در Devops – مهندسان ایده‌آل پلتفرم دارای مهارت‌های برنامه‌نویسی قوی به همراه تجربه Devops (سیستم‌عامل، شبکه، سیستم‌های توزیع‌شده، نظارت) هستند
